...
class EachCategoryCollectionViewCell: SwipeCollectionViewCell {
    ...
    override init(frame: CGRect) {
       ...
       //  addSubview(categoryLabel)
        ...
        backView.anchor(top: topAnchor, bottom: bottomAnchor, leading: leadingAnchor, trailing: trailingAnchor, paddingTop: 5, paddingBottom: 0, paddingLeft: 7, paddingRight: -7, width: 0, height: 0)
        cellBackground.backgroundColor = .red
        cellBackground.layer.cornerRadius = frame.size.height / 2  - 10
        cellBackground.anchor(top: nil, bottom: nil, leading: backView.leadingAnchor, trailing: nil, paddingTop: 10, paddingBottom: -10, paddingLeft: 10, paddingRight: 0, width: 50, height: 50)
        cellBackground.centerYAnchor.constraint(equalTo: backView.centerYAnchor, constant: 0).isActive = true
        ...
        categoryView.anchor(top: cellBackground.topAnchor, bottom: cellBackground.bottomAnchor, leading: cellBackground.leadingAnchor, trailing: cellBackground.trailingAnchor, paddingTop: 7, paddingBottom: -7, paddingLeft: 7, paddingRight: -7, width: 0, height: 0)
